...
class Comment {
    ...
    template () {
        ...
        ${this.commentData.name}</a></div><div class="comment-time" title="${this.commentData.time}">20 Seconds</div></div><div class="comment-content">${this.commentData.comment}</div></div></div>`;
